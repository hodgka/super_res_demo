...
def main():
    ...
    if mode == 'single':
        ...
        opt['save_folder'] = '../DIV2K/DIV2K800_sub'
        ...
        LR_folder = '../DIV2K/DIV2K_train_LR_bicubic/X{}'.format(scale_ratio)
        save_GT_folder = '../DIV2K/DIV2K800_sub'
        save_LR_folder = '../DIV2K/DIV2K800_sub_bicLRx{}'.format(scale_ratio)
        ########################################################################

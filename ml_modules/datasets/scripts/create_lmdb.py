...
def main():
    ...
    if dataset == 'vimeo90k':
        ...
        opt = {}
        opt['img_folder'] = '../DIV2K/DIV2K800_sub'
        opt['lmdb_save_path'] = '../DIV2K/DIV2K800_sub.lmdb'
        ...
        general_image_folder(opt)
        # LR
        opt['img_folder'] = '../DIV2K/DIV2K800_sub_bicLRx4'
        opt['lmdb_save_path'] = '../DIV2K/DIV2K800_sub_bicLRx4.lmdb'
        opt['name'] = 'DIV2K800_sub_bicLRx4'
        general_image_folder(opt)
    elif dataset == 'test':
        test_lmdb('../REDS/train_sharp_wval.lmdb', 'REDS')

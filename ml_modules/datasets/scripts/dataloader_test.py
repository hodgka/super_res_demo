...
def main():
    ...
    if dataset == 'REDS':
        opt['name'] = 'test_REDS'
        opt['dataroot_GT'] = '../REDS/train_sharp_wval.lmdb'
        opt['dataroot_LQ'] = '../REDS/train_sharp_bicubic_wval.lmdb'
        opt['mode'] = 'REDS'
        opt['N_frames'] = 5
        opt['phase'] = 'train'
        ...
        opt['dataroot_GT'] = '../vimeo90k/vimeo90k_train_GT.lmdb'
        opt['dataroot_LQ'] = '../vimeo90k/vimeo90k_train_LR7frames.lmdb'
        opt['mode'] = 'Vimeo90K'
        opt['N_frames'] = 7
        opt['phase'] = 'train'
        opt['use_shuffle'] = True
        ...
        opt['name'] = 'DIV2K800'
        opt['dataroot_GT'] = '../DIV2K/DIV2K800_sub.lmdb'
        opt['dataroot_LQ'] = '../DIV2K/DIV2K800_sub_bicLRx4.lmdb'
        opt['mode'] = 'LQGT'
        opt['phase'] = 'train'
        opt['use_shuffle'] = True
        opt['n_workers'] = 8
